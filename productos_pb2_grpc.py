...
class ProductoServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ObtenerProducto = channel.unary_unary(
                '/ferremas.ProductoService/ObtenerProducto',
                request_serializer=productos__pb2.CodigoRequest.SerializeToString,
                response_deserializer=productos__pb2.ProductoResponse.FromString,
                _registered_method=True)
        self.ListarProductos = channel.unary_unary(
                '/ferremas.ProductoService/ListarProductos',
...
def add_ProductoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ObtenerProducto': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=productos__pb2.CodigoRequest.FromString,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'ferremas.ProductoService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('ferremas.ProductoService', rpc_method_handlers)
...
class ProductoService(object):
    ...
    def ObtenerProducto(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/ferremas.ProductoService/ObtenerProducto',
            productos__pb2.CodigoRequest.SerializeToString,
